...
class Data_show_model extends CI_Model {
    ...
    public function check_for_agent_transport($begin,$end){
        $begin_time = $begin.' 00:00:00';
        $end_time = $end.' 23:59:59';
        $this->db->select('a.voyage,a.lading_bill,a.out_wharf_time,b.ship_name,c.coop_harbour,d.box_num,d.box_type,d.all_post_cost');
        $this->db->from('es_shipment_container_list a');
        //船名
        $this->db->join('es_ship_info b','b.id = a.ship_id','left');
        //目的港
