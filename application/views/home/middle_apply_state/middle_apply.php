...
<div class="content_cy">
    <div class="title_h1">出货编号 <?=$shipment_id;?>报关中管理：</div>
    <div>
    <br />
    <br />
    </div>
    <form class="work_form" style="text-align:center; " method="post" action="/home/add_middle_apply">
    ...
    <select class="work_input_01" name="contract">
    ...
    <select class="work_input_01" name="invoice">
        <option value="0">未开具</option>
        <option value="1">开具</option>
    </select>
    </p>
    ...
    <select class="work_input_01" name="packing_list">
        <option value="0">未开具</option>
        <option value="1">开具</option>
    </select>
    </p>
    ...
    <select class="work_input_01" name="permit">
        <option value="0">未开具</option>
        <option value="1">开具</option>
    </select>
    </p>
    ...
    <select class="work_input_01" name="proxy">
        <option value="0">未开具</option>
        <option value="1">开具</option>
    </select>
    </p>
    ...
    <select class="work_input_01" name="sufferance">
        <option value="0">未开具</option>
        <option value="1">开具</option>
    </select>
    </p>
    ...
    <select class="work_input_01" name="com_check">
    ...
    <select id="tex" class="work_input_01" name="tex">
    ...
    <input id="before_money" class="work_input_01" type="text" name="before_money"/>
    </p>
    
    <p class="padding_20">
    <label id="act_money_l" class="work_label_wa font_size16 color_5">实际金额 : </label>
    <input id="act_money" class="work_input_01" type="text" name="act_money"/>
    </p>
    ...
    <input id="final_money" class="work_input_01" type="text" name="final_money"/>
    </p>
    
    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">海关验货 : </label>
    <select class="work_input_01" name="sea_check">
        <option value="0">不需</option>
