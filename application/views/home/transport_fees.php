            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 bg-info">
                        ...
                        <p class="text-justify">订舱代理 : </label>
                    ...
                    <div class="col-md-2 center-align">
                        <input class="btn btn-lg btn-info" id="count_all_cost" type="button" value="计算价格"/>
                         <label style="color: red; font-size: 15px;">请在输入箱数、成本、实收海运费后点此按钮来计算向客户收取的总费用 </label>
                    </div>
                    <!--第三列-->
