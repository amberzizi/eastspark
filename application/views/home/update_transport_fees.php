...
<div class="content_cy">
    ...
    <select id="agent" class="work_input_01" name="agent">
    ...
    <input id="cargo_type" class="work_input_01" type="text" name="cargo_type" value="<?=$info_by_id[0]->cargo_type;?>"/>
    </p>
    
    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">箱型 : </label>
    <select id="box_type" class="work_input_01" name="box_type">
    ...
    <input id="box_num" class="work_input_01" type="text" name="box_num" value="<?=$info_by_id[0]->box_num;?>"/>
    </p>
    
    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">运价成本(USD):</label>
    <input id="post_cost" class="work_input_01" type="text" name="post_cost" value="<?=$info_by_id[0]->post_cost;?>"/>
    </p>

    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">海运费(USD):</label>
    <input id="sea_cost" class="work_input_01" type="text" name="sea_cost" value="<?=$info_by_id[0]->sea_cost;?>"/>
    </p>
    ...
    <input id="all_post_cost" class="work_input_01" type="text" name="all_post_cost" value="<?=$info_by_id[0]->all_post_cost;?>"/>
    </p>
    
    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">总海运费(USD):</label>
    <input id="all_sea_cost" class="work_input_01" type="text" name="all_sea_cost" value="<?=$info_by_id[0]->all_sea_cost;?>"/>
    </p>
    
    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">利润(USD):</label>
    <input id="gain" class="work_input_01" type="text" name="gain" value="<?=$info_by_id[0]->gain;?>"/>
    </p>
    
    <p class="padding_20">
    <label class="work_label_wa font_size16 color_5">收取客户 : </label>
    <select id="client" class="work_input_01" name="client">
    ...
    <select id="state" class="work_input_01" name="state">
