...
<div class="container">
    <div class="panel panel-default well">
        <div class="panel-heading">
            <p><span class="glyphicon glyphicon-user" style="color: rgb(61, 83, 144);"></span> 编辑信息</p>
        </div>
        
        <div class="panel-body bg-info">
        <form class="form-horizontal" role="form" action="/user/login_manager/save_login_admin_info_change" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="phone" placeholder="" name="phone" value="<?=$admin_info[0]->phone;?>"/>
                                </div>
                            </div> 
                            <div class="form-group">
                                <label for="company_phone" class="col-sm-4 control-label text-danger">电话</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="company_phone" placeholder="" name="company_phone" value="<?=$admin_info[0]->company_phone;?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="name" placeholder="名称" name="name" value="<?=$admin_info[0]->name;?>"/>
                                </div>
                            </div> 
                            <div class="form-group">
                    ...
                    <!--line 3 col 2-->
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="username" placeholder="" name="username" value="<?=$admin_info[0]->username;?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-sm-4 control-label text-danger">平台密码</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="pw" placeholder="" name="password" value="<?=$admin_info[0]->password;?>"/>
                                </div>
                            </div>
                            <div class="form-group">
