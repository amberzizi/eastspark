...
<div class="container"> 
 ...
 <form action="/login/coop/do_add_client" method="post" role="form" class="form-horizontal">
     <div class="form-group">
            <label for="coop_client" class="col-sm-4 control-label">名称:</label>
         <div class="col-sm-4">
            <input type="text" name="coop_client" class="form-control" id="coop_client" placeholder="请输入名称"/>
         </div>
     </div>
