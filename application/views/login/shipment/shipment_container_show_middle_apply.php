                        ...
                        <!--第一列-->
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="contract" id="contract" disabled="true">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="invoice" id="invoice" disabled="true">
                                            <option value="0">未开具</option>
                                            <option value="1">开具</option>
                                        </select>
                                    </div> 
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="packing_list" id="packing_list" disabled="true">
                                            <option value="0">未开具</option>
                                            <option value="1">开具</option>
                                        </select>
                                    </div> 
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="permit" id="permit" disabled="true">
                                            <option value="0">未开具</option>
                                            <option value="1">开具</option>
                                        </select>
                                    </div> 
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="proxy" id="proxy" disabled="true">
                                            <option value="0">未开具</option>
                                            <option value="1">开具</option>
                                        </select>
                                    </div> 
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="sufferance" id="sufferance" disabled="true">
                                            <option value="0">未开具</option>
                                            <option value="1">开具</option>
                                        </select>
                                    </div> 
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="com_check" id="com_check" disabled="true">
                                            <option value="0">未开具</option>
                                            <option value="1">开具</option>
                                        </select>
                                    </div> 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="tex" id="tex" disabled="true">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input disabled="true" id="before_money" class="form-control" type="text" name="before_money" value="<?=$info_by_id[0]->before_money;?>"/>
                                        </div>
                                </div>
                                <!--实际金额-->
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input disabled="true" id="act_money" class="form-control" type="text" name="act_money" value="<?=$info_by_id[0]->act_money;?>"/>
                                        </div>
                                </div>
                                <!--计算按钮-->
                                 <input class="btn btn-primary center-block" id="count" type="button" value="计算差额" disabled="true"/>
                                <!--应收金额-->
                                <div class="form-group" style="padding-top: 20px;">
                                        ...
                                        <div class="col-sm-6">
                                            <input disabled="true" id="final_money" class="form-control" type="text" name="final_money" value="<?=$info_by_id[0]->final_money;?>"/>
                                        </div>
                                </div>
                                <!--海关验货-->
                                <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="sea_check" id="sea_check" disabled="true">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea disabled="true" id="content" class="form-control" name="content" style="height: 50px;"><?=$info_by_id[0]->content;?></textarea>
