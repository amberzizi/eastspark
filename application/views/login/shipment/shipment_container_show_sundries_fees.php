...
<div class="container">
    ...
    <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="fee_out" class="form-control" type="text" name="fee_out" value="<?=$info[0]->fee_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付THC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="thc_out" class="form-control" type="text" name="thc_out" value="<?=$info[0]->thc_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付ECRS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ecrs_out" class="form-control" type="text" name="ecrs_out" value="<?=$info[0]->ecrs_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付TTS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="tts_out" class="form-control" type="text" name="tts_out" value="<?=$info[0]->tts_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付CHC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="chc_out" class="form-control" type="text" name="chc_out" value="<?=$info[0]->chc_out;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                    <!--第二列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="se_out" class="form-control" type="text" name="se_out" value="<?=$info[0]->se_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付卸车费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="unload_out" class="form-control" type="text" name="unload_out" value="<?=$info[0]->unload_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付装箱费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_out" class="form-control" type="text" name="box_out" value="<?=$info[0]->box_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付舱单费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ship_out" class="form-control" type="text" name="ship_out" value="<?=$info[0]->ship_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付文件费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="file_out" class="form-control" type="text" name="file_out" value="<?=$info[0]->file_out;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                    <!--第三列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="sea_out" class="form-control" type="text" name="sea_out" value="<?=$info[0]->sea_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付商检费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="check_out" class="form-control" type="text" name="check_out" value="<?=$info[0]->check_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付水科所-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="water_out" class="form-control" type="text" name="water_out" value="<?=$info[0]->water_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付危申费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="d_out" class="form-control" type="text" name="d_out" value="<?=$info[0]->d_out;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应付验货费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="search_out" class="form-control" type="text" name="search_out" value="<?=$info[0]->search_out;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group">
                        <input class="btn btn-primary center-block" id="count_out" type="button" value="计算应付金额" disabled="true"/>
                    </div>
                </div>
                <!--第五行-->
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_fee_out" class="form-control" type="text" name="box_fee_out" value="<?=$info[0]->box_fee_out;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="boxs_fees_out" class="form-control" type="text" name="boxs_fees_out" value="<?=$info[0]->boxs_fees_out;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="fee_in" class="form-control" type="text" name="fee_in" value="<?=$info[0]->fee_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收THC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="thc_in" class="form-control" type="text" name="thc_in" value="<?=$info[0]->thc_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收ECRS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ecrs_in" class="form-control" type="text" name="ecrs_in" value="<?=$info[0]->ecrs_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收TTS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="tts_in" class="form-control" type="text" name="tts_in" value="<?=$info[0]->tts_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收CHC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="chc_in" class="form-control" type="text" name="chc_in" value="<?=$info[0]->chc_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收代理费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="agent_in" class="form-control" type="text" name="agent_in" value="<?=$info[0]->agent_in;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                     <!--第二列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="se_in" class="form-control" type="text" name="se_in" value="<?=$info[0]->se_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收卸车费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="unload_in" class="form-control" type="text" name="unload_in" value="<?=$info[0]->unload_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收装箱费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_in" class="form-control" type="text" name="box_in" value="<?=$info[0]->box_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收舱单费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ship_in" class="form-control" type="text" name="ship_in" value="<?=$info[0]->ship_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收文件费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="file_in" class="form-control" type="text" name="file_in" value="<?=$info[0]->file_in;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                     <!--第三列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="sea_in" class="form-control" type="text" name="sea_in" value="<?=$info[0]->sea_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收商检费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="check_in" class="form-control" type="text" name="check_in" value="<?=$info[0]->check_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收水科所-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="water_in" class="form-control" type="text" name="water_in" value="<?=$info[0]->water_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收危申费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="d_in" class="form-control" type="text" name="d_in" value="<?=$info[0]->d_in;?>" disabled="true"/>
                                </div>
                        </div>
                        <!--应收验货费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="search_in" class="form-control" type="text" name="search_in" value="<?=$info[0]->search_in;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group">
                        <input class="btn btn-primary center-block" id="count_in" type="button" value="计算应收金额" disabled="true"/>
                    </div>
                </div>
                <!--第九行-->
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_fee_in" class="form-control" type="text" name="box_fee_in" value="<?=$info[0]->box_fee_in;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="boxs_fees_in" class="form-control" type="text" name="boxs_fees_in" value="<?=$info[0]->boxs_fees_in;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group">
                        <input class="btn btn-primary center-block" id="count_gain" type="button" value="计算利润" disabled="true"/>
                    </div>
                </div>
                <!--第十一行-->
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="gain" class="form-control" type="text" name="gain" value="<?=$info[0]->gain;?>" disabled="true"/>
                                </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
