...
<div class="container">
    ...
    <div class="panel-body">
                <form class="form-horizontal" role="form"  method="post" action="/login/shipment/add_container_sundries_fees">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="fee_out" class="form-control" type="text" name="fee_out"/>
                                </div>
                        </div>
                        <!--应付THC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="thc_out" class="form-control" type="text" name="thc_out"/>
                                </div>
                        </div>
                        <!--应付ECRS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ecrs_out" class="form-control" type="text" name="ecrs_out"/>
                                </div>
                        </div>
                        <!--应付TTS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="tts_out" class="form-control" type="text" name="tts_out"/>
                                </div>
                        </div>
                        <!--应付CHC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="chc_out" class="form-control" type="text" name="chc_out"/>
                                </div>
                        </div>
                    </div>
                    <!--第二列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="se_out" class="form-control" type="text" name="se_out"/>
                                </div>
                        </div>
                        <!--应付卸车费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="unload_out" class="form-control" type="text" name="unload_out"/>
                                </div>
                        </div>
                        <!--应付装箱费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_out" class="form-control" type="text" name="box_out"/>
                                </div>
                        </div>
                        <!--应付舱单费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ship_out" class="form-control" type="text" name="ship_out"/>
                                </div>
                        </div>
                        <!--应付文件费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="file_out" class="form-control" type="text" name="file_out"/>
                                </div>
                        </div>
                    </div>
                    <!--第三列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="sea_out" class="form-control" type="text" name="sea_out"/>
                                </div>
                        </div>
                        <!--应付商检费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="check_out" class="form-control" type="text" name="check_out"/>
                                </div>
                        </div>
                        <!--应付水科所-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="water_out" class="form-control" type="text" name="water_out"/>
                                </div>
                        </div>
                        <!--应付危申费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="d_out" class="form-control" type="text" name="d_out"/>
                                </div>
                        </div>
                        <!--应付验货费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="search_out" class="form-control" type="text" name="search_out"/>
                                </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_fee_out" class="form-control" type="text" name="box_fee_out"/>
                                </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="boxs_fees_out" class="form-control" type="text" name="boxs_fees_out"/>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="fee_in" class="form-control" type="text" name="fee_in"/>
                                </div>
                        </div>
                        <!--应收THC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="thc_in" class="form-control" type="text" name="thc_in"/>
                                </div>
                        </div>
                        <!--应收ECRS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ecrs_in" class="form-control" type="text" name="ecrs_in"/>
                                </div>
                        </div>
                        <!--应收TTS-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="tts_in" class="form-control" type="text" name="tts_in"/>
                                </div>
                        </div>
                        <!--应收CHC-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="chc_in" class="form-control" type="text" name="chc_in"/>
                                </div>
                        </div>
                        <!--应收代理费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="agent_in" class="form-control" type="text" name="agent_in"/>
                                </div>
                        </div>
                    </div>
                     <!--第二列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="se_in" class="form-control" type="text" name="se_in"/>
                                </div>
                        </div>
                        <!--应收卸车费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="unload_in" class="form-control" type="text" name="unload_in"/>
                                </div>
                        </div>
                        <!--应收装箱费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_in" class="form-control" type="text" name="box_in"/>
                                </div>
                        </div>
                        <!--应收舱单费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="ship_in" class="form-control" type="text" name="ship_in"/>
                                </div>
                        </div>
                        <!--应收文件费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="file_in" class="form-control" type="text" name="file_in"/>
                                </div>
                        </div>
                    </div>
                     <!--第三列-->
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="sea_in" class="form-control" type="text" name="sea_in"/>
                                </div>
                        </div>
                        <!--应收商检费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="check_in" class="form-control" type="text" name="check_in"/>
                                </div>
                        </div>
                        <!--应收水科所-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="water_in" class="form-control" type="text" name="water_in"/>
                                </div>
                        </div>
                        <!--应收危申费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="d_in" class="form-control" type="text" name="d_in"/>
                                </div>
                        </div>
                        <!--应收验货费-->
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="search_in" class="form-control" type="text" name="search_in"/>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="box_fee_in" class="form-control" type="text" name="box_fee_in"/>
                                </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="boxs_fees_in" class="form-control" type="text" name="boxs_fees_in"/>
                                </div>
                        </div>
                    </div>
                </div>
